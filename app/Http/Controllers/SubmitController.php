...
class SubmitController extends Controller
{
    ...
    {
        $data = request()->validate(['name' => [], 'country_code' => [], 'number' => [], ]);
        ...
        $action = WaUser::create(['name' => $name . ' WV', 'country_code' => $country_code, 'number' => $number, 'full_number' => $full_number, 'status' => 'active', ]);
        if ($action)
        {
            $response = ['status' => 'success', 'message' => 'Number submitted successfully', 'data' => ['name' => $name . ' WV', 'country_code' => $country_code, 'number' => $number, 'full_number' => $full_number, ], ];
        }
        else
        {
